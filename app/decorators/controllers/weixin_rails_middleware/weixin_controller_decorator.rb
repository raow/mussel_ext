...
WeixinRailsMiddleware::WeixinController.class_eval do
  ...
  private
    ...
    def response_text_message(options={})
      Response::TextMessage.create_by_msg(@weixin_message)
    ...
    def response_location_message(options={})
      Response::LocationMessage.create_by_msg(@weixin_message)
    ...
    def response_image_message(options={})
      ...
      Response::ImageMessage.create_by_msg(@weixin_message)
    ...
    def response_link_message(options={})
      ...
      Response::LinkMessage.create_by_msg(@weixin_message)
    ...
    def response_voice_message(options={})
      ...
      Response::VoiceMessage.create_by_msg(@weixin_message)
    ...
    def response_video_message(options={})
      ...
      Response::VideoMessage.create_by_msg(@weixin_message)
      reply_text_message("回复视频信息")
    end

    def response_event_message(options={})
      event_type = @weixin_message.Event
      Response::EventMessage.create_by_msg(@weixin_message)
    ...
    private
      ...
      def handle_subscribe_event
        ...
        Response::EventMessage.create_by_msg(@weixin_message)
        WechatUser.subscribe(@weixin_message.FromUserName)
      ...
      def handle_unsubscribe_event
        Response::EventMessage.create_by_msg(@weixin_message)
        WechatUser.unsubscribe(@weixin_message.FromUserName)
      ...
      def handle_location_event # 上报地理位置事件
        ...
        Response::EventMessage.create_by_msg(@weixin_message)
        WechatUser.set_location(@weixin_message.FromUserName,@lat,@lgt)
      ...
      def handle_click_event
        Response::EventMessage.create_by_msg(@weixin_message)
        reply_text_message(API::Common.menu_click(@weixin_message.EventKey,@weixin_message.FromUserName))
      end
