...
RSpec.describe "service_order_items/edit", :type => :view do
  before(:each) do
  ...
  it "renders the edit service_order_item form" do
    render

    assert_select "form[action=?][method=?]", service_order_item_path(@service_order_item), "post" do
